...
def train(model_name: str, C: float, max_iter: int, solver: str, output_dir: str = "models"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--solver", default="lbfgs")
    ...
    train(args.model_name, args.C, args.max_iter, args.solver, args.output_dir)