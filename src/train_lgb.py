...
def train(model_name: str, num_leaves: int, learning_rate: float, n_estimators: int, output_dir: str = "models"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-l", "--num-leaves", type=int, default=31)
    ...
    train(args.model_name, args.num_leaves, args.learning_rate, args.n_estimators, args.output_dir)
